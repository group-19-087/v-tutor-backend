...
var metaDataSchema = new Schema({
  ...
  codeStatus: { type: String, enum: ['processing', 'done'] },
  slidesStatus: { type: String, enum: ['processing', 'done'] },
  topicsStatus: { type: String, enum: ['processing', 'done'] },
  questionsStatus: { type: String, enum: ['processing', 'done'] },
  video_url: String,
